...
nat = 2
ads_atoms = [1, 2]   
moved_atoms = [H, H] #the order must be consistent with the order in QE input
...
# =========================
# Vibrational enthalpy correction
# =========================
#Hvib_J = np.sum(
#    0.5 * HBAR * real_omega +
#    (HBAR * real_omega) /
...
print(f"\nZPE               = {ZPE_eV:.6f} eV")
#print(f"H_vib({T} K)      = {Hvib_eV:.6f} eV")
